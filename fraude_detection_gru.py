...
# 3. Mise en forme pour GRU (reshape en [samples, timesteps=1, features])
...
plt.ylabel("Actual")
plt.title("Matrice de Confusion - GRU")
plt.show()
...
model_path = "export_gru_model/1"
model.export(model_path)
print(f"Modèle GRU exporté dans : {model_path}")